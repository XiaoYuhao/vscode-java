...
import { StatusBarItem, window, StatusBarAlignment, TextEditor, Uri, commands, workspace, version, languages, Command, ExtensionContext, Selection, Location } from "vscode";
...
import { addLombokChangeVersionCommand, LombokVersionItemFactory, importedLombok, getLombokVersion } from "./lombokSupport";
